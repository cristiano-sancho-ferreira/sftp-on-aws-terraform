...
def lambda_handler(event, context):
    ...
    source_ip = event['sourceIp']  # to check individual user IP
    ...
    if 'IPAllowList' in resp_dict:
      ip_allow_list = json.loads(resp_dict['IPAllowList'])  # convert string list to list of strings

      if source_ip not in ip_allow_list:  # convert string list to list of strings
          print("Invalid connecting IP")
          return {}
